<section class="section3" id="Menus">
  <div class="container">
    ...
    <div class="services flex">
      <div class="img top hover:shine">
        <img class="service-1" src="./assets/img/service-1.jpg" alt="">
      </div>
      <div class="img">
        <img class="service-2" src="./assets/img/service-2.jpg" alt="">
      </div>
      <div class="img top">
        <img class="service-3" src="./assets/img/service-3.jpg" alt="">
      </div>
    </div>
  </div>
</section>